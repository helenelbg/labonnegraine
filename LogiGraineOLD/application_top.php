<?php
    ...
    if ( !isset($_SESSION['pda']) || empty($_SESSION['pda']) )
    {
    ...
    {
        if ( substr($_SERVER['SCRIPT_NAME'], 0, 21) != '/LogiGraine/index.php' )
        {
            die('<h1>Accès non autorisé</h1>');
        }
    }

    $liste_commandes = Commande::getCommandesByPda($_SESSION['pda']);
?>