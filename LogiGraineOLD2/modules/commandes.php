                ...
                if ( strpos($liste_commandes[0], '_') > 0 )
                {
                    ...
                    else
                    {
                        ...
                        foreach($produitsEC as $produitEC)
                        {
                            ...
                            echo '<input type="text" id="codeProduit" data-produit="'.$produitEC['product_ean13'].'" value="'.$produitEC['product_ean13'].'" onblur="if ( this.value == \'\' ) focus();" name="codeProduit" class="form-control" placeholder="Scannez le produit" required autofocus>';
                            //echo '<button class="btn btn-lg btn-primary btn-block" type="submit">Valider</button>';
                            ...
                            echo '<input type="text" id="codeCaisseCheck" data-caisse="'.$caisse_attendue.'" value="'.$caisse_attendue.'" name="codeCaisseCheck" class="form-control" placeholder="Scannez la caisse '.($positions[$position_a_mettre]).'">';
        ...
        $('#form-produit-multi #codeProduit').keypress(function (e) {
          ...
          if (keyCode == 13)
          {
            ...
            else if ( $('#form-produit-multi #codeProduit').val() != $('#form-produit-multi #codeProduit').attr('data-produit') )
            {
                ...
                $('#myModalErreur').modal('show');
                $('#myModalErreur .btnFermer').attr('onclick', "$('#form-produit-multi #codeProduit').focus();");
