<?php
        ...
        public function dispatch()
    {
        ...
        if ( $this->controller == 'orderopc')
        {
            $this->controller = 'order';
        }
        //error_log($this->controller.'//'.$this->controller_not_found);
        ...
        switch ($this->front_controller) {
            ...
            case self::FC_FRONT:
                ...
                if (!isset($controllers[strtolower($this->controller)])) {   
                    ...
                    if ( $_SERVER['REQUEST_URI'] == '/commande' )
                    {
                        Mail::send(1,
                        'error',
                        'Erreur 404 page commande',
                        array(),
                        array('guillaume@anjouweb.com', 'andy@anjouweb.com'),
                        'Anjou Web',
                        'info@labonnegraine.com',
                        'La Bonne Graine');
                        error_log($this->controller.'//'.$this->controller_not_found);
                    }
