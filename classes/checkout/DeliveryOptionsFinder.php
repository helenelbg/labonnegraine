                ...
                foreach ($carriers_list as $carriers) {
                    if (is_array($carriers)) {
                        foreach ($carriers as $carrier) {
                            ...
                            {
                                $carrier['extraContent'] = '<div class="div_cac"><span class="zone1">Vous avez choisi le retrait sur place à l\'adresse suivante :</span><br /><br />
 ...
 *Le mercredi de 8h00 à 16h00</span></div>';
                            ...
                            elseif ( $carrier['id_reference'] == 155 )
                            {
                                $carrier['extraContent'] = '<button type="button" class="btn btn-primary" id="dpd-select-pickup-point" name="dpdSelectPickupPoint" value="1">
