...
class ProductsCategory extends Module
{
	...
	public function __construct()
	{
		...
		$this->ps_versions_compliancy = array('min' => '1.6', 'max' => '99.99.99.99');
	}
	...
	public function hookDisplayFooterProduct($params){
		...
		//error_log(print_r($category_products,true)); 



//        return $this->display(dirname(__FILE__), 'views/templates/hook/displayFooterProduct.tpl');
			
return $this->display(__FILE__, 'views/templates/front/productscategory.tpl');
            //echo $this->display(__FILE__, 'displayFooterProduct.tpl');

//        print_r($this->context->smarty->fetch($this->local_path . 'views/templates/hook/displayFooterProduct.tpl'));
//        return $this->context->smarty->fetch('views/templates/hook/front/productscategory.tpl');
//		return $this->display(__FILE__, 'productscategory.tpl');
		//return $this->fetch('module:productscategory/productscategory.tpl');
    }
