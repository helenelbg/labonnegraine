<div class="panel">
	<h3><i class="icon-cogs"></i> {l s='Clients' d='Modules.utm'}</h3>
    <div class="table-responsive">
        ...
        <table class="table table-bordered table-striped">
            <thead class="thead-light">
                <tr>
                    <th>{l s='id_customer' d='Modules.utm'}</th>
                    ...
                    <th>{l s='utm_expire' d='Modules.utm'}</th>
                    <th>{l s='inscription' d='Modules.utm'}</th>
                    <th>{l s='derniere visite' d='Modules.utm'}</th>
                </tr>
            </thead>
            <tfoot>
                <tr>
            ...
            <tbody>
                {foreach from=$data item=line}
                    <tr class="product-line-row">
                        <td>{if $line.id_customer eq ""}--{else}{$line.id_customer}{/if}</td>
                        ...
                        <td>{if $line.utm_expire eq ""}--{else}{$line.utm_expire|date_format:"%d/%m/%Y %T"}{/if}</td>
                        <td>{if $line.date_add eq ""}--{else}{$line.date_add|date_format:"%d/%m/%Y %T"}{/if}</td>
                        <td>{if $line.lastVisite eq ""}--{else}{$line.lastVisite|date_format:"%d/%m/%Y %T"}{/if}</td>
                    </tr>
                {/foreach}
            </tbody>
        </table>
        ...
        $(function() {
            ...
            $('.table').tablesorter({
                ...
                widgetOptions : {
                    ...
                    filter_reset : ".reset",
                    filter_formatter : {
                        'th:contains("utm_expire"), th:contains("visite"), th:contains("inscription")' : function($cell, indx) {
            ...
            $(".tablesorter-filter-row [data-column='8'] label, .tablesorter-filter-row [data-column='9'] label, .tablesorter-filter-row [data-column='10'] label").css("display", "none");
        });
    </script>
{/literal}