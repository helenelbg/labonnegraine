...
class DPDCompliancy
{
     ...
     * @param string $toThisVersion Version à comparer
     * @return bool
     */
    public static function isMyPrestashopVersion($operator, $toThisVersion)
    {
        return version_compare(_PS_VERSION_, $toThisVersion, $operator);
    }
}
