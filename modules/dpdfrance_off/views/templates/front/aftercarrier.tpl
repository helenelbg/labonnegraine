...
<div class="modal_box modal_dpd" style="display: none;">
    <div class="modal_content modal_content_dpd">
        <span class="modal_close modal_close_dpd">×</span>
        <div class="modal-dpd-row-1">
