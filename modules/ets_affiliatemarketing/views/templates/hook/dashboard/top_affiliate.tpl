...
<table class="table top_affilate">
	<thead>
		<tr>
			<th class="text-left">{l s='Affiliate' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Customers joined affiliate program' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Orders' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Number of orders which affiliates successfully sold' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Turnover' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Order total generated by affiliate products' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Affiliate rewards' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Total rewards earned of an affiliate' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
