...
<table class="table top_customer">
	<thead>
		<tr>
			...
			<th class="text-center">{l s='Orders' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Total order numbers of a customer' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Total paid' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Total order generated by loyalty products' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Loyalty rewards' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Amount of reward a customer earned' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
