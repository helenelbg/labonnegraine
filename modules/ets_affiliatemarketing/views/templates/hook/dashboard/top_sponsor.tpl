...
<table class="table top_sponsor">
	<thead>
		<tr>
			<th class="text-left">{l s='Sponsor' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='Existing customers referred your website & products to their friends to get reward' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Friends' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s="The number of sponsor's friend registered new account on your website" mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Orders' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s="The number of orders which sponsor's friend purchased" mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Total order cost' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s="Total earning from orders of sponsor's friend" mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
			<th class="text-center">{l s='Sponsor rewards' mod='ets_affiliatemarketing'}
				<span data-toggle="tooltip" data-placement="top" title="{l s='The amount of rewards a sponsor earned' mod='ets_affiliatemarketing'}">
					{$_svg_question_circle_icon nofilter}
				</span>
			</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-right">
				<a href="{$customer_link nofilter}&id_reward_users={$ord.id_customer|escape:'html':'UTF-8'}&viewreward_users"  class="btn btn-default" data-toggle="tooltip" data-placement="top" title="{l s='View user' mod='ets_affiliatemarketing'}">{$_svg_search nofilter}</a></td>
		</tr>
		{/foreach}
		{else}
			<tr>
