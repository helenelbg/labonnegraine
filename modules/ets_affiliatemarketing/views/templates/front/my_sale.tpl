        ...
        <tr>
            ...
            <th>
                ...
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="product_name" data-order-way="DESC">{$_svg_desc nofilter}</a>
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="product_name" data-order-way="ASC">{$_svg_asc nofilter}</a>
            </th>
            <th class="text-center" style="min-width: 120px; max-width: 120px; white-space: normal; ">
                ...
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="number_sales" data-order-way="DESC">{$_svg_desc nofilter}</a>
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="number_sales" data-order-way="ASC">{$_svg_asc nofilter}</a>
            </th>
           <th class="text-center" style="min-width: 120px; max-width: 120px; white-space: normal; ">
                ...
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="number_orders" data-order-way="DESC">{$_svg_desc nofilter}</a>
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="number_orders" data-order-way="ASC">{$_svg_asc nofilter}</a>
            </th>
            <th class="text-center">
                ...
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="earning_rewards" data-order-way="DESC">{$_svg_desc nofilter}</a>
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="earning_rewards" data-order-way="ASC">{$_svg_asc nofilter}</a>
            </th>
            <th class="text-center">
                ...
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="total_views" data-order-way="DESC">{$_svg_desc nofilter}</a>
                <a href="javascript:void(0)" title=""
                   ...
                   data-order-by="total_views" data-order-way="ASC">{$_svg_asc nofilter}</a>
            </th>
            <th class="text-center">
