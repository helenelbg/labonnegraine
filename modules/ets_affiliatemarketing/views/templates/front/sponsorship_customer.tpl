    ...
    <div class="col-lg-8">
        <div class="product_info">
            ...
            <p class="mb-5">
                ...
                {dateFormat date=$customer_info.date_add full=1}
            </p>
        </div>
    </div>
</div>
<div class="content mt-15 clearfix">
    <div class="eam-dashboard ">
        ...
        <div class="row action-back">
            <div class="col-lg-4">
                <a href="{$link_back|escape:'html':'UTF-8'}" title="" class="btn btn-default eam-btn-back-link mb-15">{$_svg_arrow_circle_left nofilter} {l s='Back' mod='ets_affiliatemarketing'}</a>
            </div>
