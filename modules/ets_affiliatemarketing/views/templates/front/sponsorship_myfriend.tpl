		...
		<thead>
			<tr>
				<th>{l s='ID' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'id'}active{/if} " data-order-by="id" data-order-way="DESC">{$_svg_desc nofilter}</a>
					<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'id'}active{/if}" data-order-by="id" data-order-way="ASC">{$_svg_asc nofilter}</a>
				</th>
                {if $display_name}
    				<th>{l s='Name' mod='ets_affiliatemarketing'}
						<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'firstname'}active{/if}" data-order-by="firstname" data-order-way="DESC">{$_svg_desc nofilter}</a>
						<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'firstname'}active{/if}" data-order-by="firstname" data-order-way="ASC">{$_svg_asc nofilter}</a>
					</th>
                {/if}
				{if $display_email}
				<th class="text-left">{l s='Email' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'email'}active{/if}" data-order-by="email" data-order-way="DESC">{$_svg_desc nofilter}</a>
					<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'email'}active{/if}" data-order-by="email" data-order-way="ASC">{$_svg_asc nofilter}</a>
				</th>
				{/if}
				<th class="text-center">{l s='Level' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'level'}active{/if}" data-order-by="level" data-order-way="DESC">{$_svg_desc nofilter}</a>
					<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'level'}active{/if}" data-order-by="level" data-order-way="ASC">{$_svg_asc nofilter}</a>
				</th>
				<th class="text-center">{l s='Orders' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'order'}active{/if}" data-order-by="order" data-order-way="DESC">{$_svg_desc nofilter}</a>
					<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'order'}active{/if}" data-order-by="order" data-order-way="ASC">{$_svg_asc nofilter}</a>
				</th>
				<th class="text-center">{l s='Earning reward approved' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'reward'}active{/if}" data-order-by="reward" data-order-way="DESC">{$_svg_desc nofilter}</a>
					<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'reward'}active{/if}" data-order-by="reward" data-order-way="ASC">{$_svg_asc nofilter}</a>
				</th>
				<th class="text-center">{l s='Friend(s)' mod='ets_affiliatemarketing'}
					<a href="javascript:void(0)" title="" class="eam-sort-desc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'desc' && isset($query.orderBy) && $query.orderBy == 'friend'}active{/if}" data-order-by="friend" data-order-way="DESC">{$_svg_desc nofilter}</a>
					<a href="javascript:void(0)" title="" class="eam-sort-asc js-eam-order-data {if isset($query.orderWay) && $query.orderWay == 'asc' && isset($query.orderBy) && $query.orderBy == 'friend'}active{/if}" data-order-by="friend" data-order-way="ASC">{$_svg_asc nofilter}</a>
				</th>
                ...
                <div class="row">
                    ...
                    <div class="eam_action">
                        <div class="form-group">
							<button type="submit" class="btn btn-default js-btn-submit-filter">{$_svg_search nofilter} {l s='Filter' mod='ets_affiliatemarketing'}</button>
