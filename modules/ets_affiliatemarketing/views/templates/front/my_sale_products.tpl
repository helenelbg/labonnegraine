...
<div class="content mt-15 clearfix">
    <div class="eam-dashboard ">
                ...
                {if count($ets_am_customer_orders.results)}
                    {foreach from=$ets_am_customer_orders.results item=sale}
                        <tr>
                            ...
                            {/if}
                            <td class="text-center">{dateFormat date=$sale.datetime_added full=1}</td>
        ...
        <div class="row">
            <div class="col-lg-4">
                <a href="{$my_sale_url nofilter}" title="" class="btn btn-default eam-btn-back-link mb-15">{$_svg_arrow_circle_left nofilter} {l s='Back' mod='ets_affiliatemarketing'}</a>
            </div>
            <div class="col-lg-8">
