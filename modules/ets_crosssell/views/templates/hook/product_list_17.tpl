...
{if isset($products) && $products}
    <div class="featured-products product_list">
    	<div data-row-desktop="{$nbItemsPerLine|intval}" data-row-tablet="{$nbItemsPerLineTablet|intval}" data-row-mobile="{$nbItemsPerLineMobile|intval}" id="{$name_page|escape:'html':'UTF-8'}-{$tab|escape:'html':'UTF-8'}" class="{$name_page|escape:'html':'UTF-8'} product_list product-list product_grid grid products crosssell_product_list_wrapper{if isset($tab) && $tab} cs-wrapper-{$tab|escape:'html':'UTF-8'}{/if} layout-{$layout_mode|escape:'html':'UTF-8'} ets_mp_desktop_{$nbItemsPerLine|intval} ets_mp_tablet_{$nbItemsPerLineTablet|intval} ets_mp_mobile_{$nbItemsPerLineMobile|intval}">
