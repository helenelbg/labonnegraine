...
class cdc_googletagmanager extends Module
{
	...
	public function __construct()
	{
        ...
        $this->bootstrap = true;
        $this->ps_versions_compliancy = array('min' => '1.5', 'max' => '8.1.99');
    ...
    public function hookDisplayBackOfficeHeader()
    {
        ...
        if($this->gtm_enable && !empty($this->gtm_id)) {
            ...
            static::createMissingCdcGtmOrderLogs();
            ...
            if ($this->recreateOrderConfirmationFromBO() // create a datalayer order confirmation from BO
                ...
                if($this->recreateOrderConfirmationFromBO()
                    || $this->generateEnhancedEcommerceOrderResend()) {
