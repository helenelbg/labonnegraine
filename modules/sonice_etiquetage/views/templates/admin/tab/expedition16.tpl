...
<div id="tab-exp" style="display: none;">
    ...
    <div class="barcode-div float-right">
        <form name="order_send" class="form-inline" role="form">
            <span>{l s='Scan outgoing packages' mod='sonice_etiquetage'} :</span> <img src="{$sne_img|escape:'htmlall':'UTF-8'}douchette_1.png" class="sne_douchette" alt="douchette"><input type="text" placeholder="{l s='Parcel Number' mod='sonice_etiquetage'}" class="barcode-input form-control">
        </form>
    </div>
    ...
    <!-- Error div -->
    <div id="sne_error_exp" class="alert alert-danger" style="display: none;">
        {l s='An error occured.' mod='sonice_etiquetage'}<br>
        <code></code>
    </div>
    <!-- Warning div -->
    <div id="sne_warn_exp" class="alert alert-warning" style="display: none;">
        {l s='Something unexpected occured.' mod='sonice_etiquetage'}<br>
        <code></code>
    </div>
    <!-- Success div -->
    <div id="sne_conf_exp" class="alert alert-success" style="display: none;">
    ...
    <button class="btn" id="send_all_exp">{l s='Send' mod='sonice_etiquetage'}</button>
    ...
    <h2>{l s='Outgoing packages' mod='sonice_etiquetage'}</h2>
