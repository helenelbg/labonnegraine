...
<div class="panel" id="tabs">
    ...
    <ul class="nav nav-pills" id="menuTab">
        <li id="menu-session" class="active"><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}report_stack.png" alt="package" />&nbsp; Session</a></li>
        <li id="menu-listing" class=""><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}to_do_list_cheked_all.png" alt="list" />&nbsp; {l s='Listing' mod='sonice_etiquetage'}</a></li>
        <li id="menu-orders" class=""><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}barcode.png" alt="package" />&nbsp; {l s='Orders' mod='sonice_etiquetage'}</a></li>
        <li id="menu-exp" class=""><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}package_go.png" alt="package" />&nbsp; {l s='Expedition' mod='sonice_etiquetage'}</a></li>
        <li id="menu-close" class=""><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}lock.png" alt="package" />&nbsp; {l s='Close session' mod='sonice_etiquetage'}</a></li>
        <li id="mode-compact" class="" style="float: right;"><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}zone_resize_small.png" alt="package" />&nbsp; {l s='Compact Mode' mod='sonice_etiquetage'}</a></li>
        <li id="mode-normal" class="" style="float: right; display: none;"><a href="#"><img src="{$sne_img|escape:'htmlall':'UTF-8'}zone_resize_big.png" alt="package" />&nbsp; {l s='Normal Mode' mod='sonice_etiquetage'}</a></li>
    </ul>
    <hr style="width: 100%;">

    <!-- SESSION -->
    {include file="$sne_module_path/views/templates/admin/tab/session16.tpl"}

    <!-- LISTING -->
    {include file="$sne_module_path/views/templates/admin/tab/listing16.tpl"}

    <!-- ORDERS -->
    {include file="$sne_module_path/views/templates/admin/tab/orders16.tpl"}

    <!-- EXPEDITION -->
    {include file="$sne_module_path/views/templates/admin/tab/expedition16.tpl"}

    <!-- CLOSE -->
    {include file="$sne_module_path/views/templates/admin/tab/close16.tpl"}
</div>
