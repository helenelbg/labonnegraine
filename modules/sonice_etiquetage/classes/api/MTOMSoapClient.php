 ...
 * It decodes XML and integrate attachment in the XML response.
 *
 * @author    Alexandre D. <debuss-a>
 * @copyright Copyright (c) 2016-2017 Alexandre D. <debuss-a>
 * @license   MIT
 * @version   1.0.0
 * @see       https://github.com/debuss/MTOMSoapClient
 */

if (class_exists('MTOMSoapClient')) {
    return false;
}
...
class MTOMSoapClient extends SoapClient
{
     ...
     *
     * It replaces the :
     *      <xop:Include href="cid:d08bab58-dfea-43f0-8520-477d4c5e0677-103@cxf.apache.org"
     ...
     * @param int $version
     * @param int $one_way
     * @return string The XML SOAP response with <xop> tag content replaced by base64 corresponding attachment
    ...
    public function __doRequest($request, $location, $action, $version, $one_way = 0)
    {
        ...
        if (is_array($xop_elements) && count($xop_elements)) {
            foreach ($xop_elements as $xop_element) {
                ...
                $binary = base64_encode(trim($binary[1]));
