...
class ColissimoTools
{
    ...
    /** @var array $isoDom Countries */
    public static $isoDom = array('GP', 'MQ', 'YT', 'GF', 'RE', 'UK');
    
    /** @var array $isoDomDDP Countries (if is active DDP)*/
    public static $isoDomDDP = array('ZA', 'SA', 'AU', 'BH', 'CA', 'CN','KR', 'EG', 'AE', 'US', 'HK', 'ID', 'JP', 'KW', 'MX', 'OM', 'PH', 'SG', 'GB', 'CH', 'TH' );
    
    /** @var array $isoDDP Countries (20 ISO) */
    public static $isoDDP = array('AE', 'BH', 'CA', 'CH', 'CN', 'EG', 'GB', 'HK', 'ID', 'JP', 'KR', 'KW', 'MX', 'OM', 'PH', 'SA', 'SG', 'TH', 'US', 'ZA');

    /** @var array $isoPostalPartner Countries that allow the choice of delivery either via the postal partner or via DPD */
    public static $isoPostalPartner = array('DE', 'AT', 'IT', 'LU');
