...
class ColissimoPickupPoint extends ObjectModel
{
    ...
    /** @var array $availableIso Countries that allow pickup point (25 ISO) */
    public static $availableIso = array('IE', 'DK', 'IT', 'AD', 'AT', 'BE', 'DE', 'ES', 'FR', 'EE', 'HU', 'LT', 'LU', 'LV', 'MC', 'NL', 'PL', 'PT', 'SE', 'DK', 'FI', 'CZ', 'SK', 'SI');
