...
<fieldset>
    ...
    <a href="{$currentUrl|escape:'htmlall':'UTF-8'}{$baseParams|escape:'htmlall':'UTF-8'}&sc_step=2" class="sc_bouton loading">{l s='Start downloading and installing SC' mod='storecommander'}</a>
</fieldset>