<?php $LANG =array (
  ...
  'Enable PNG format support in Store Commander and Prestashop.<br/>Possible values:<br/>0: No PNG support (Prestashop standard)<br/>1: PNG file is renamed with JPG file extension<br/>2: Both PNG and JPG format are used.<br/><a target="_blank" href="https://www.storecommander.com/redir.php?dest=2021080601">See documentation</a>' => 'Povolit podporu PNG formátu ve Store Commanderu a PrestaShopu<br/>Možné hodnoty:<br/>0: Nepodporovat PNG (standardní nastavení PrestaShopu)<br/>1: PNG je převeden na JPG<br/>2: Oba formáty (PNG i JPG) jsou používány<br/>Více informací naleznete v dokumentaci',
