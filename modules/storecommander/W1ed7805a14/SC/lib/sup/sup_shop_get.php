...
function getShopTree($sc_agent, &$has_restrictions)
{
    $tree = array();
    ...
    foreach ($tree as $groups)
    {
        echo ' <item '.
            ...
            ' im1="'.$icon.'"'.
            ' im2="'.$icon.'">
                                    <itemtext><![CDATA['.$groups['data']['title']."]]></itemtext>\n";
        foreach ($groups['children'] as $shops)
        {
            echo '  <item '.
                ...
                ' im1="'.$icon.'"'.
                ' im2="'.$icon.'">
                                        <itemtext><![CDATA['.$shops['data']['title']."]]></itemtext>\n";
            echo '</item>'."\n";
            ++$i;
        }
        echo '</item>'."\n";
...
echo '<tree id="0">';
getShopTree($sc_agent, $has_restrictions);
