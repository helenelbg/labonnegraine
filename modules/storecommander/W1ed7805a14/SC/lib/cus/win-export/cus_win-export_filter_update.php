...
$filderId = Tools::getValue(ExportCustomerFilter::$definition['primary'],null);

$filterObject = new ExportCustomerFilter($filderId);
...
switch ($action)
{
    ...
    case 'delete_filter':
        ...
        $exportListFound = ExportCustomer::getExportByFilter($filterObject->id);
        if($exportListFound)
        {
