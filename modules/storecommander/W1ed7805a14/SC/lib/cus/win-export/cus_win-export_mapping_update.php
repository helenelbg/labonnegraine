...
$mappingId = Tools::getValue(ExportCustomerMapping::$definition['primary'],null);

$mappingObject = new ExportCustomerMapping($mappingId);
...
switch ($action)
{
    case 'add_mapping':
        ...
        $mappingObject->format_properties = 'delimitor::;@@display_header::1';
    ...
    case 'delete_mapping':
        ...
        $exportListFound = ExportCustomer::getExportByMapping($mappingObject->id);
        if($exportListFound)
        {
