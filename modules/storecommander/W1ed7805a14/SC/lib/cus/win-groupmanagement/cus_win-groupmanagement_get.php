...
<column id="date_add" width="140" type="ro" align="left" sort="int"><?php echo _l('Date add'); ?></column>
<column id="date_upd" width="140" type="ro" align="left" sort="int"><?php echo _l('Modified date'); ?></column>
</head>
<?php
