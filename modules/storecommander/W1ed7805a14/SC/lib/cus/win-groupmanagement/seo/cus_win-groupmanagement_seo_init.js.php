...
cus_group_prop_tb.addListOption('cus_group_prop_subproperties', 'cus_group_prop_seo', 2, "button", '<?php echo _l('Name', 1); ?>', "fad fa-align-left");
...
cus_group_prop_tb.attachEvent("onClick", function(id){
    if(id=="cus_group_prop_seo")
    {
        ...
        cus_group_prop_tb.setItemImage('cus_group_prop_subproperties', 'fad fa-align-left');
...
cus_group_prop_tb.addButton('cus_group_prop_seo_refresh',100,'','fa fa-sync green','fa fa-sync green');
cus_group_prop_tb.setItemToolTip('cus_group_prop_seo_refresh','<?php echo _l('Refresh grid', 1); ?>');
cus_group_prop_tb.addButton('cus_group_prop_seo_selectall',100,'','fa fa-bolt yellow','fa fa-bolt yellow');
