<?php
    ...
    function getGroups()
    {
        ...
        foreach ($groups as $row)
        {
            ...
            echo '<cell><![CDATA['.$row['id_group'].']]></cell>';
...
<head>
<beforeInit>
<call command="attachHeader"><param><![CDATA[#numeric_filter,#text_filter,#select_filter,#select_filter]]></param></call>
</beforeInit>
<column id="id" width="60" type="ro" align="right" sort="int"><?php echo _l('ID'); ?></column>
<column id="name" width="200" type="ro" align="left" sort="str"><?php echo _l('Group'); ?></column>
...
<?php echo '<userdata name="uisettings">'.uisettings::getSetting('cus_groups').'</userdata>'."\n";
    getGroups();
?>
</rows>