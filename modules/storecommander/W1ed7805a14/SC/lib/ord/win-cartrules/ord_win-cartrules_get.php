...
<rows id="0">
    <head>
        ...
        <column id="date_from" width="140" type="ed" align="left" sort="str"><?php echo _l('Date from'); ?></column>
        <column id="date_to" width="140" type="ed" align="left" sort="str"><?php echo _l('Date to'); ?></column>
        ...
        <column id="reduction_percent" width="80" type="ro" align="right" sort="int"><?php echo _l('Reduction percent'); ?></column>
        <column id="reduction_amount" width="80" type="ro" align="right" sort="int"><?php echo _l('Reduction amount'); ?></column>
