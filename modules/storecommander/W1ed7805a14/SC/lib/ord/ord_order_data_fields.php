...
$colSettings['new_customer'] = array('text' => _l('New customer'), 'width' => 45, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array(0 => _l('No'), 1 => _l('Yes')));
...
$colSettings['valid'] = array('text' => _l('Valid'), 'width' => 45, 'align' => 'center', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array(0 => _l('No'), 1 => _l('Yes')));
$colSettings['recyclable'] = array('text' => _l('Recyclable'), 'width' => 45, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array(0 => _l('No'), 1 => _l('Yes')));
$colSettings['gift'] = array('text' => _l('Gift'), 'width' => 45, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array(0 => _l('No'), 1 => _l('Yes')));
$colSettings['gift_message'] = array('text' => _l('Gift message'), 'width' => 100, 'align' => 'center', 'type' => 'txt', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');

$colSettings['payment'] = array('text' => _l('Payment'), 'width' => 80, 'align' => 'left', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => $arrPayments);
...
$colSettings['status_date'] = array('text' => _l('Status update'), 'width' => 140, 'align' => 'left', 'type' => 'ro'/*'edtxt'*/ , 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
$colSettings['invoice_number'] = array('text' => _l('Invoice No'), 'width' => 45, 'align' => 'right', 'type' => 'ro', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter');
$colSettings['invoice_date'] = array('text' => _l('Invoice date'), 'width' => 140, 'align' => 'left', 'type' => 'ro'/*'edtxt'*/ , 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
$colSettings['delivery_number'] = array('text' => _l('Delivery No'), 'width' => 45, 'align' => 'right', 'type' => 'ro', 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter');
$colSettings['delivery_date'] = array('text' => _l('Delivery slip date'), 'width' => 140, 'align' => 'left', 'type' => 'edtxt', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
$colSettings['date_add'] = array('text' => _l('Creation date'), 'width' => 140, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
$colSettings['date_upd'] = array('text' => _l('Modified date'), 'width' => 140, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
$colSettings['instock'] = array('text' => _l('In stock'), 'width' => 45, 'align' => 'center', 'type' => 'ro', 'sort' => 'int', 'color' => '', 'filter' => '#select_filter');
$colSettings['pdf'] = array('text' => _l('PDF'), 'width' => 90, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => ' ');
...
$colSettings['tracking_url'] = array('text' => _l('Tracking url'), 'width' => 70, 'align' => 'center', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '');
...
{
    $colSettings['product_price_tax_incl'] = array('text' => _l('Product price incl. tax'), 'width' => 70, 'align' => 'right', 'type' => 'ro'/*'edn'*/ , 'sort' => 'int', 'color' => '', 'filter' => '#numeric_filter', 'format' => '0.00', 'footer' => '#stat_total');
}
if (SCI::getConfigurationValue('SC_DELIVERYDATE_INSTALLED') == '1')
{
    $colSettings['delivery_info'] = array('text' => _l('Delivery date'), 'width' => 140, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
    $colSettings['delivery_date_standard'] = array('text' => _l('Delivery date - Standard'), 'width' => 140, 'align' => 'left', 'type' => 'ro'/*'edtxt'*/ , 'sort' => 'str', 'color' => '', 'filter' => '#numeric_filter');
    $colSettings['delivery_date_limit'] = array('text' => _l('Delivery date - Limit'), 'width' => 140, 'align' => 'left', 'type' => 'ro'/*'edtxt'*/ , 'sort' => 'str', 'color' => '', 'filter' => '#numeric_filter');
}
...
{
    $colSettings['product_mpn'] = array('text' => _l('MPN'), 'width' => 70, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter', 'onlyforgrids' => array('grid_picking'));
}
...
{
    $colSettings['is_pack'] = array('text' => _l('Pack'), 'width' => 45, 'align' => 'center', 'type' => 'coro', 'sort' => 'str', 'color' => '', 'filter' => '#select_filter', 'options' => array());
}
...
$colSettings['customization'] = array('text' => _l('Customization'), 'width' => 150, 'align' => 'left', 'type' => 'ro', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
if (version_compare(_PS_VERSION_, '1.7.8.0', '>='))
{
    $colSettings['note'] = array('text' => _l('Note'), 'width' => 200, 'align' => 'left', 'type' => 'txttxt', 'sort' => 'str', 'color' => '', 'filter' => '#text_filter');
}
