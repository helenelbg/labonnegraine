...
$data = ExportOrder::getExportCronList();
$xml = array();
if ($data)
{
    ...
    foreach ($data as $row)
    {
        ...
        $row_xml[] = '<cell title="'._l('Copy to ClipBoard').'"><![CDATA[<button onclick="copyCronUrlToClipboard('.(int) $row[ExportOrder::$definition['primary']].')" ><i class="fad fa-copy"></i></button>]]></cell>';
...
<rows id="0">
    <head>
        ...
        <column id="<?php echo ExportOrder::$definition['primary']; ?>" width="50" type="ro" align="left" sort="int"><?php echo _l('ID'); ?></column>
        ...
        <column id="copy" width="50" type="ro" align="left" sort="str"></column>
    </head>
    <?php
    echo $xml;
    ?>
