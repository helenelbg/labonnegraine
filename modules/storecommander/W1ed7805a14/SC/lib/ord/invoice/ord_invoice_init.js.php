<?php if (_r('GRI_ORD_PROPERTIES_GRID_INVOICE')) { ?>
    ...
    function displayOrderInvoice()
    {
        ...
        prop_tb._orderInvoiceGrid.load("index.php?ajax=1&act=ord_invoice_get&id_customer="+customers_id+"&id_lang="+SC_ID_LANG,function()
        {
