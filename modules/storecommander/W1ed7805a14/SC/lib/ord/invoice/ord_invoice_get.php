...
<column id="delivery_date" width="140" type="dhxCalendarA" align="right" sort="date"><?php echo _l('Delivery date'); ?></column>
<column id="total_discount_tax_excl" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total discount Tax excl'); ?></column>
<column id="total_discount_tax_incl" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total discount Tax incl'); ?></column>
<column id="total_paid_tax_excl" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total paid Tax excl'); ?></column>
<column id="total_paid_tax_incl" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total paid Tax incl'); ?></column>
<column id="total_products" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total products'); ?></column>
<column id="total_products_wt" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total products WT'); ?></column>
...
<column id="total_wrapping_tax_excl" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total wrapping Tax excl'); ?></column>
<column id="total_wrapping_tax_incl" width="80" type="ro" format="0.00" align="right" sort="int"><?php echo _l('Total wrapping Tax incl'); ?></column>
