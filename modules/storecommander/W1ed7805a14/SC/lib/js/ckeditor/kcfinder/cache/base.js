...
_.returnFile = function(file) {
    ...
    var uploadURL = _.uploadURL;
    if(uploadURL!="/")
        uploadURL =  _.uploadURL + "/";

    var button, win, fileURL = file.substr
        ? file : uploadURL + _.dir + "/" + file.data('name');
...
_.viewImage = function(data) {
    ...
    showImage = function(data) {
        ...
        var tmpurl = $.$.escapeDirs(_.uploadURL + "/" + _.dir + "/" + data.name);
        tmpurl = tmpurl.replace("//","/");
        var url = tmpurl + "?ts=" + ts,
            img = new Image(),
            i = $(img),
            w = $(window),
            d = $(document);
...
/** This file is part of KCFinder project
  ...
  *      @link http://kcfinder.sunhater.com
  */
_.initDropUploadAlreadyCalled = false;
_.initDropUpload = function() {
    if(_.initDropUploadAlreadyCalled) {
        return;
    }
    _.initDropUploadAlreadyCalled = true;
