...
cat_prop_tb.addListOption('cat_prop_subproperties', 'cat_prop_shopshare', 5, "button", '<?php echo _l('Multistore sharing manager', 1); ?>', "fa fa-sitemap white");
...
cat_prop_tb.attachEvent("onClick", function(id){
    if(id=="cat_prop_shopshare")
    {
        ...
        cat_prop_tb.setItemImage('cat_prop_subproperties', 'fa fa-sitemap white');
...
cat_prop_tb.addButton('cat_prop_shopshare_refresh',100,'','fa fa-sync green','fa fa-sync green');
cat_prop_tb.setItemToolTip('cat_prop_shopshare_refresh','<?php echo _l('Refresh grid', 1); ?>');
cat_prop_tb.addButton("cat_prop_shopshare_add_select", 100, "", "fad fa-link yellow", "fad fa-link yellow");
cat_prop_tb.setItemToolTip('cat_prop_shopshare_add_select','<?php echo _l('Add all selected categories to all selected shops', 1); ?>');
cat_prop_tb.addButton("cat_prop_shopshare_del_select", 100, "", "fad fa-unlink red", "fad fa-unlink red");
