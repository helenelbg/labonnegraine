    ...
    wCatImport.tbOptions.attachEvent("onClick",
        function(id){
            ...
            if (id=='download')
            {
                ...
                window.open("index.php?ajax=1&act=all_get-file&type=import&path=category&file="+wCatImport.gridFiles.cells(wCatImport.gridFiles.getSelectedRowId(),idxFilename).getValue());
            }
            if (id=='delete')
            {
