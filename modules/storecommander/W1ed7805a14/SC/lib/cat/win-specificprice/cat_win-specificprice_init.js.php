...
<?php
 ...
 { ?>
    ...
    <?php if (SCMS) { ?>
        ...
        specificPrice_shoptree.setImagePath('lib/js/imgs/dhxtree_material/');
    ...
    // CATEGORIES
        ...
        specificPrice_cattree.setImagePath('lib/js/imgs/dhxtree_material/');
            ...
            specificPrice_cattree.load("index.php?ajax=1&act=cat_category_get&id_lang="+SC_ID_LANG+"<?php if (SCMS)
 {
    ...
    specificPrice_filtertree.setImagePath('lib/js/imgs/dhxtree_material/');
...
// SPECIFIC PRICE GRID
    ...
    getTbSettingsButton(specificPrice_gridTB, {'grideditor':1,'settings':0}, 'win_speprice_', 80);
