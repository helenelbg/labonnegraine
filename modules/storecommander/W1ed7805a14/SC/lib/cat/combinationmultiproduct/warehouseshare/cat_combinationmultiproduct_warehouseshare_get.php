<?php
    ...
    $idlist_arr = explode(',', $idlist_temp);
    $idlist = array();
    ...
    foreach ($exps as $id)
    {
        if (SCMS)
        {
            $c = new Combination((int) $id, (int) $id_lang, (int) SCI::getSelectedShop());
        }
        else
        {
    ...
    if (!$multiple)
    {
        if (SCMS)
        {
            $combination = new Combination((int) $idlist, (int) $id_lang, (int) SCI::getSelectedShop());
        }
        else
        {
