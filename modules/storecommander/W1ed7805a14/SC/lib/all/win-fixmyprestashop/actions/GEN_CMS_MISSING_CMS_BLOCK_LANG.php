...
if (!empty($post_action) && $post_action == 'do_check')
{
    ...
    if (!empty($res) && count($res) > 0)
    {
        ...
        <script type="text/javascript">
            ...
            gridMissingCmsBlockLang.setColTypes("ro");
            gridMissingCmsBlockLang.setColSorting("int");
            gridMissingCmsBlockLang.attachHeader("#numeric_filter");
            ...
            sbMissingCmsBlockLang=dhxlSCExtCheck.tabbar.cells("table_GEN_CMS_MISSING_CMS_BLOCK_LANG").attachStatusBar();
