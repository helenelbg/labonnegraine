...
class CustomerAddressFormatterCore implements FormFormatterInterface
{
    ...
    private function getFieldLabel($field)
    {
        ...
        switch ($field) {
            ...
            case 'city':
                return $this->translator->trans('City', array(), 'Admin.Global');
            case 'Country':
                return $this->translator->trans('Country', array(), 'Admin.Global');
            case 'State':
                return $this->translator->trans('State', array(), 'Admin.Global');
            case 'phone':
            ...
            case 'company':
                return $this->translator->trans('Company', array(), 'Admin.Global');
            case 'vat_number':
