...
cms_prop_tb.addListOption('cms_prop_subproperties', 'cms_prop_info', 1, "button", '<?php echo _l('Name & description', 1); ?>', "fad fa-align-left");
...
cms_prop_tb.addButton('cms_prop_info_refresh',100,'','fa fa-sync green','fa fa-sync green');
cms_prop_tb.setItemToolTip('cms_prop_info_refresh','<?php echo _l('Refresh grid', 1); ?>');
if (lightNavigation)
{
    cms_prop_tb.addButtonTwoState('cms_prop_info_lightNavigation', 100, "", "fa fa-mouse-pointer", "fa fa-mouse-pointer");
