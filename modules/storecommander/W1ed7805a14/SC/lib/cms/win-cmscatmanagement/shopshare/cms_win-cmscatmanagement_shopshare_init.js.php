...
cms_prop_tb.addListOption('cms_prop_subproperties', 'cms_prop_shopshare', 3, "button", '<?php echo _l('Multistore sharing manager', 1); ?>', "fa fa-sitemap white");
...
cms_prop_tb.attachEvent("onClick", function(id){
    if(id=="cms_prop_shopshare")
    {
        ...
        cms_prop_tb.setItemImage('cms_prop_subproperties', 'fa fa-sitemap white');
...
cms_prop_tb.addButton('cms_prop_shopshare_refresh',100,'','fa fa-sync green','fa fa-sync green');
cms_prop_tb.setItemToolTip('cms_prop_shopshare_refresh','<?php echo _l('Refresh grid', 1); ?>');
cms_prop_tb.addButton("cms_prop_shopshare_add_select", 100, "", "fad fa-link yellow", "fad fa-link yellow");
...
cms_prop_tb.addButton("cms_prop_shopshare_del_select", 100, "", "fad fa-unlink red", "fad fa-unlink red");
