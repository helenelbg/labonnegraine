            ...
            if (!empty($auto_params['id_segment']))
            {
                ...
                if ($segment->type == 'manual')
                {
                    ...
                    FROM '._DB_PREFIX_.'orders o
                            INNER JOIN '._DB_PREFIX_."sc_segment_element se ON (se.id_element = o.id_customer AND se.type_element='customer' AND se.id_segment=".(int)$auto_params['id_segment'].")";
                }
                elseif ($segment->type == 'auto')
                {
                    ...
                    if (is_array($res_segment) && !empty($res_segment))
                    {
                        ...
                        $sql = 'SELECT DISTINCT(o.id_order)
                                FROM '._DB_PREFIX_.'orders o
                                WHERE o.id_customer IN ('.pInSQL(implode(',', $ids)).')';
                    }
                }
                if (!empty($sql))
                {
