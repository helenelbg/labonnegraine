...
<div id="action_{$action->id_quantity_discount_rule_action|intval}_container" class="col-lg-12 action">
    <div class="row">
        ...
        <div class="col-lg-10">
            ...
            <div class="form-group" id="action_condition_group_price[{$action->id_quantity_discount_rule_action|intval}]">
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="row row-margin-top">
                        <label class="control-label col-lg-3">{l s='Compute discount from product price without group discount' mod='quantitydiscountpro'}</label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                <span class="switch prestashop-switch fixed-width-lg" id="action_apply_discount_to_group_price_{$action->id_quantity_discount_rule_action|intval}">
                                    <input type="radio" name="action_apply_discount_to_group_price[{$action->id_quantity_discount_rule_action|intval}]" id="action_apply_discount_to_group_price_on_{$action->id_quantity_discount_rule_action|intval}" value="1" {if $action->apply_discount_to_group_price|intval}checked="checked"{/if} />
                                    <label class="t" for="action_apply_discount_to_group_price_on_{$action->id_quantity_discount_rule_action|intval}">{l s='Yes' mod='quantitydiscountpro'}</label>
                                    <input type="radio" name="action_apply_discount_to_group_price[{$action->id_quantity_discount_rule_action|intval}]" id="action_apply_discount_to_group_price_off_{$action->id_quantity_discount_rule_action|intval}" value="0" {if !$action->apply_discount_to_group_price|intval}checked="checked"{/if}/>
                                    <label class="t" for="action_apply_discount_to_group_price_off_{$action->id_quantity_discount_rule_action|intval}">{l s='No' mod='quantitydiscountpro'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 help-block">
                                    {l s='If enabled and the customer has a group discount, the percentage discount will be computed from the regular product price without the group discount.' mod='quantitydiscountpro'}
                                </div>
                            </div>
                        </div>
                    </div>
