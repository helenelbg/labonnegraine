...
<div class="wk-bundle-sub-product">     
    <div class="wk-bp-custom-margin-2-b wk-bp-custom-margin-2-t" style="line-height: 1.7rem;">
        <strong><a href="{$product.link}" target='blank'>
            <span class="wk-sub-product-title" itemprop="name">{$product.name}</span>
        </a></strong>
		...
		<div id="wk-product-description-short-{$product.id}" itemprop="description" class="wk-bp-custom-margin-t">
