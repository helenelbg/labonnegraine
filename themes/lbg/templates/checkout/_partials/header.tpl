...
<style>
	...
	{if Configuration::get('MP_LOGO_B')}
	  {literal}
	  .Bandeau_Top .row #header_logo a::before {
      ...
      <div class="row">
        <div class="desktop">
          ...
          <div class="col-md-7 right-nav">
              <a type="button" name="submit_search" class="btn btn-default button-search" href="#" tabindex="1"></a>
              <div class="header_user_info header_user_info_wishlist">
                  <a href="{$link->getModuleLink('blockwishlist', 'lists', array(), true)|escape:'html':'UTF-8'}">
                  </a>
              </div>
              {hook h='displayNav2'}
          </div>
