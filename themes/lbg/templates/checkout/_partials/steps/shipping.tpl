...
{block name='step_content'}
  ...
  <div class="delivery-options-list">
    {if $delivery_options|count}
      ...
      >
        <div class="form-fields">
                      ...
                      <div class="row">
                        <div class="col-sm-4 col-xs-12">
                          <div class="row carrier{if $carrier.logo} carrier-hasLogo{/if}">
                            {if $carrier.logo}
                            <div class="col-xs-12 col-md-2 carrier-logo">
                                <img src="{$carrier.logo}" alt="{$carrier.name}" loading="lazy" />
                            </div>
                            {/if}
                            <div class="col-xs-12 col-md-10 carriere-name-container{if $carrier.logo} col-md-7{/if}">
          ...
          {* AJOUT ANDY 27/04 - DEBUT *}

          <div class="customExtraContent"></div>

          {* AJOUT ANDY 27/04 - FIN *}
    ...
    {elseif isset($aw_erreur) && $aw_erreur}
		<p class="alert alert-danger">{$aw_erreur nofilter}
		<br><a href="/panier?action=show"><input type="button" class="btn btn-primary float-xs-right" value="Revenir au panier"></a><br><br>
		</p>
    {else}
