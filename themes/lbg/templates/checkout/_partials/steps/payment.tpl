...
{block name='step_content'}
  ...
  {if $conditions_to_approve|count}
    ...
    <p class="carrier_title cgv">Conditions générales de vente</p>
          ...
          <li>
            ...
            <div class="condition-label">
              <label for="conditions_to_approve[{$condition_name}]">
                {*$condition nofilter*}
                J'ai lu les <a target="_blank" href="/content/3-conditions-generales-de-ventes">conditions générales de vente</a> et j'y adhère sans réserve.
              </label>
            </div>
          </li>
        {/foreach}
  ...
  <div class="payment-options">
    {foreach from=$payment_options item="module_options"}
      {foreach from=$module_options item="option"}
        <div>
          <div id="{$option.id}-container" class="payment-option clearfix" data-name="{$option.module_name}">
        ...
        {if $option.additionalInformation || $is_free}
          <div
          ...
          >
			...
			{if $option.module_name != "paypal"}
				{$payconfirmation = "payment-confirmation-"|cat:$option.id}
			{/if}
			<div id="{$payconfirmation}" class="js-payment-confirmation">
				<div class="ps-shown-by-js">
				  <button type="submit" class="btn btn-primary center-block{if !$selected_payment_option} disabled{/if}" disabled-tooltip="Veuillez accepter les conditions générales de vente">
					{l s='Payer' d='Shop.Theme.Checkout'}
				  </button>
