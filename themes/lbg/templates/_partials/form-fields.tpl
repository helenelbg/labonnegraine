...
{elseif $field.name != 'optin' && $field.name != 'newsletter'}
      ...
      {elseif $field.type === 'checkbox'}
        ...
        {block name='form_field_item_checkbox'}
			  ...
			  {if $field.name == 'customer_privacy'}
				  {$field.label = "Message concernant la confidentialité des données clients. Conformément aux dispositions de la loi du n°78-17 du 6 janvier 1978, vous disposez d'un droit d'accès, de rectification et d'opposition sur les données nominatives vous concernant."}
			  {/if}
