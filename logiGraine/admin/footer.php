    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btnFermer" data-dismiss="modal">Fermer</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade succes" id="myModalSucces" role="dialog">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default lien" data-dismiss="modal">Valider</button>
            </div>
        </div>
    </div>
</div>
...
<script src="/LogiGraine/admin/custom.js?v=2"></script>
