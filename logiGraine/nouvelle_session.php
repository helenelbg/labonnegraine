...
//return true;
    ...
    foreach($explode_cmd as $multi)
    {
        ...
        if ( $resu_v[0]['current_state'] != 2 && $resu_v[0]['current_state'] != 3 && $resu_v[0]['current_state'] != 47 )
        {
            $exeOK = false;
        }
    }
    ...
    if ( $exeOK == true )
    {
        ...
        {           
            ...
            $reqdd = 'DELETE FROM ps_LogiGraine_controle_produit_ordre WHERE id_order = "'.$cmd.'";';
            Db::getInstance(_PS_USE_SQL_SLAVE_)->execute($reqdd);
        }
