                ...
                if ( strpos($liste_commandes[0], '_') > 0 )
                {
                    ...
                    else
                    {
                        ...
                        foreach($produitsEC as $produitEC)
                        {
                            ...
                            echo '<div class="product_ref" style="background-color: '.$array_bg_caisse[ceil(($position_a_mettre+1)/6)].'">Caisse '.$array_lettre_caisse[ceil(($position_a_mettre+1)/6)].($positionEtage).'</div>';

                            echo '<input type="text" id="codeCaisseCheck" data-caisse="'.$caisse_attendue.'" name="codeCaisseCheck" class="form-control" placeholder="Scannez la caisse '.$array_lettre_caisse[ceil(($position_a_mettre+1)/6)].($positionEtage).'">';
