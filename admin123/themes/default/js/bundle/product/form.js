  ...
  return {
    init() {
      ...
      function resetAttachmentForm() {
        ...
        $('#form_step6_attachment_product_picto').val('');
      ...
      $('#form_step6_attachment_product_add').click(function () {
		...
		if ($('#form_step6_attachment_product_picto')[0].files[0]) {
          data.append('product_attachment[picto]', $('#form_step6_attachment_product_picto')[0].files[0]);
        }
...
$(document).ready(function() {
	let html = '<div class="checkbox"><label class="form-check-label"><input type="checkbox" id="cocher_tout_les_transporteurs"> Cocher tout</label></div>';
	$('#form_step4_selectedCarriers').prepend(html);
	
	$(document).on("click", "#cocher_tout_les_transporteurs", function(e) {
		let checked = $(this).is(':checked');		
		$('input[name="form[step4][selectedCarriers][]"]').prop( "checked", checked );	
	});
});
