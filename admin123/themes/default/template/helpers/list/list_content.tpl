...
{foreach $list AS $index => $tr}
	...
	{/if}
	{if $smarty.get.controller == "AdminCartRules"}	
		<td class="aw-orders">
			<input type="button" class="btn js-aw-show-orders" value="Commandes">
		</td>
	{/if}
	</tr>
{/foreach}
...
<div class="modal-box modal-box-aw-orders">
  <div class="modal-content modal-content-aw-orders">
  <span class="modal-close">&times;</span>
	<div class="modal-section-aw-orders">
