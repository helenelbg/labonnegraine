...
/* Smarty version 4.2.1, created on 2025-06-04 08:07:09
  from '/home/dev.labonnegraine.com/public_html/modules/ybc_blog/views/templates/hook/related_posts_category.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_683fe28ddd6176_41263616',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8439c66d6c3d6513ea92794b68352ab42cfb9c27' => 
    array (
      0 => '/home/dev.labonnegraine.com/public_html/modules/ybc_blog/views/templates/hook/related_posts_category.tpl',
      1 => 1738070956,
      2 => 'file',
    ),
  ),
...
function content_683fe28ddd6176_41263616 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '1554260177683fe28ddc5546_98330680';
?>

<?php if ($_smarty_tpl->tpl_vars['posts']->value) {?>
    <div data-items="<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RELATED_CATEGORY_ROW']), ENT_QUOTES, 'UTF-8');?>
" class="block ybc_block_related_category_page ybc_block_related <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RTL_CLASS'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
} else { ?>page_blog<?php }?> <?php if ((isset($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_CATEGORY_POST_TYPE'])) && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_CATEGORY_POST_TYPE'] == 'default' || count($_smarty_tpl->tpl_vars['posts']->value) <= 1) {?> ybc_block_default<?php } else { ?> ybc_block_slider<?php }?>">
        <h4 class="title_blog title_block"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Related posts','mod'=>'ybc_blog'),$_smarty_tpl ) );?>
</h4>
        <?php if ((isset($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RELATED_CATEGORY_ROW'])) && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RELATED_CATEGORY_ROW']) {?>
            <?php $_smarty_tpl->_assignInScope('product_row', intval($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RELATED_CATEGORY_ROW']));?>
        <?php } else { ?>
            <?php $_smarty_tpl->_assignInScope('product_row', 4);?>
        <?php }?>
        <div class="ybc_blog_content_block<?php if (count($_smarty_tpl->tpl_vars['posts']->value) > 1 && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_CATEGORY_POST_TYPE'] != 'default') {?> blog_type_slider<?php }?>">
            <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <span class="post-date">
                                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0], array( array('date'=>$_smarty_tpl->tpl_vars['post']->value['datetime_added'],'full'=>0),$_smarty_tpl ) );?>
