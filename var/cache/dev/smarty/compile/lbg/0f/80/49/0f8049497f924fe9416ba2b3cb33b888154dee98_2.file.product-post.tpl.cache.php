...
/* Smarty version 4.2.1, created on 2025-06-02 08:50:56
  from '/home/dev.labonnegraine.com/public_html/modules/ybc_blog/views/templates/hook/product-post.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_683d49d0adc6f8_93962787',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0f8049497f924fe9416ba2b3cb33b888154dee98' => 
    array (
      0 => '/home/dev.labonnegraine.com/public_html/modules/ybc_blog/views/templates/hook/product-post.tpl',
      1 => 1738070956,
      2 => 'file',
    ),
  ),
...
function content_683d49d0adc6f8_93962787 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '869765647683d49d0acade5_40567676';
?>

<?php if ($_smarty_tpl->tpl_vars['posts']->value) {?>
    <div data-items="<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RELATED_POST_ROW_IN_PRODUCT']), ENT_QUOTES, 'UTF-8');?>
"
         class="ybc-blog-related-posts on_product ybc_blog_related_posts_type_<?php if ($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_PRODUCT_POST_TYPE']) {
...
} else { ?>default<?php }?> ybc_blog_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_PRODUCT_POST_TYPE'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
">
        ...
        <div class="ybc-blog-related-posts-wrapper">
            <?php $_smarty_tpl->_assignInScope('post_row', intval($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RELATED_POST_ROW_IN_PRODUCT']));?>
            <div class="ybc_blog_content_block ybc-blog-related-posts-list dt-<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['post_row']->value), ENT_QUOTES, 'UTF-8');
if ($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_PRODUCT_POST_TYPE'] == 'carousel') {?> blog_type_slider<?php }?>">
                <?php
...
?>                                            
                    <div class="ybc_blog_content_block_item ybc-blog-related-posts-list-li col-xs-12 col-sm-4 col-lg-<?php echo htmlspecialchars((string) 12/intval($_smarty_tpl->tpl_vars['post_row']->value), ENT_QUOTES, 'UTF-8');?>
 thumbnail-container">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <?php }?>
                            <span class="post-date"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['dateFormat'][0], array( array('date'=>$_smarty_tpl->tpl_vars['rpost']->value['datetime_added'],'full'=>0),$_smarty_tpl ) );?>
</span>
                        </div>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['show_views']->value) {?>
                                    <span class="ybc-blog-latest-toolbar-views">
                                        <i class="ets_svg">
                                                            ...
                                                            </i> <?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['click_number']), ENT_QUOTES, 'UTF-8');?>
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'view','mod'=>'ybc_blog'),$_smarty_tpl ) );
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['allow_like']->value) {?>
                                    <span class="ybc-blog-like-span ybc-blog-like-span-<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['id_post']), ENT_QUOTES, 'UTF-8');?>
 <?php if ((isset($_smarty_tpl->tpl_vars['rpost']->value['liked'])) && $_smarty_tpl->tpl_vars['rpost']->value['liked']) {?>active<?php }?>"  data-id-post="<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['id_post']), ENT_QUOTES, 'UTF-8');?>
">                        
                                        <i class="ets_svg">
                                        ...
                                        </i> <span class="ben_<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['id_post']), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['likes']), ENT_QUOTES, 'UTF-8');?>
</span>
                                        <span class="blog-post-like-text blog-post-like-text-<?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['id_post']), ENT_QUOTES, 'UTF-8');?>
">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['allowComments']->value && $_smarty_tpl->tpl_vars['rpost']->value['comments_num'] > 0) {?>
                                    <span class="ybc-blog-latest-toolbar-comments"><i class="ets_svg"><svg width="14" height="14" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="M896 384q-204 0-381.5 69.5t-282 187.5-104.5 255q0 112 71.5 213.5t201.5 175.5l87 50-27 96q-24 91-70 172 152-63 275-171l43-38 57 6q69 8 130 8 204 0 381.5-69.5t282-187.5 104.5-255-104.5-255-282-187.5-381.5-69.5zm896 512q0 174-120 321.5t-326 233-450 85.5q-70 0-145-8-198 175-460 242-49 14-114 22h-5q-15 0-27-10.5t-16-27.5v-1q-3-4-.5-12t2-10 4.5-9.5l6-9 7-8.5 8-9q7-8 31-34.5t34.5-38 31-39.5 32.5-51 27-59 26-76q-157-89-247.5-220t-90.5-281q0-174 120-321.5t326-233 450-85.5 450 85.5 326 233 120 321.5z"/></svg>
                                                                </i> <?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['rpost']->value['comments_num']), ENT_QUOTES, 'UTF-8');?>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['display_desc']->value) {?>
                            <?php if ($_smarty_tpl->tpl_vars['rpost']->value['short_description']) {?>
                                <div class="blog_description"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( strip_tags($_smarty_tpl->tpl_vars['rpost']->value['short_description']),120,'...' )),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</div>
                            <?php } elseif ($_smarty_tpl->tpl_vars['rpost']->value['description']) {?>
                                <div class="blog_description"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( strip_tags($_smarty_tpl->tpl_vars['rpost']->value['description']),120,'...' )),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</div>
                            <?php }?>
                        <?php }?>
