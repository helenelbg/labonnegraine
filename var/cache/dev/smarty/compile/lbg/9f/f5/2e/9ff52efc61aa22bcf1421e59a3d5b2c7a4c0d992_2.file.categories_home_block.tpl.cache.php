...
/* Smarty version 4.2.1, created on 2025-06-02 08:50:56
  from '/home/dev.labonnegraine.com/public_html/modules/ybc_blog/views/templates/hook/categories_home_block.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.1',
  'unifunc' => 'content_683d49d054a980_33498334',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9ff52efc61aa22bcf1421e59a3d5b2c7a4c0d992' => 
    array (
      0 => '/home/dev.labonnegraine.com/public_html/modules/ybc_blog/views/templates/hook/categories_home_block.tpl',
      1 => 1738070956,
      2 => 'file',
    ),
  ),
...
function content_683d49d054a980_33498334 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '2010024652683d49d0535c06_40708880';
if ((isset($_smarty_tpl->tpl_vars['categoires']->value)) && $_smarty_tpl->tpl_vars['categoires']->value) {?>
    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['categoires']->value, 'category');
$_smarty_tpl->tpl_vars['category']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['category']->value) {
$_smarty_tpl->tpl_vars['category']->do_else = false;
?>
        <?php if ((isset($_smarty_tpl->tpl_vars['category']->value['posts'])) && $_smarty_tpl->tpl_vars['category']->value['posts']) {?>
            <div class="block ybc_block_category <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_RTL_CLASS'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
if ((isset($_smarty_tpl->tpl_vars['blog_page']->value)) && $_smarty_tpl->tpl_vars['blog_page']->value == 'home') {?>
    <?php if ((isset($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_HOME_POST_TYPE'])) && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_HOME_POST_TYPE'] == 'default' || count($_smarty_tpl->tpl_vars['category']->value['posts']) <= 1) {?>ybc_block_default<?php } else { ?>ybc_block_slider<?php }
} else { ?>
    <?php if ((isset($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_SIDEBAR_POST_TYPE'])) && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_SIDEBAR_POST_TYPE'] == 'default' || count($_smarty_tpl->tpl_vars['category']->value['posts']) <= 1) {?>ybc_block_default<?php } else { ?>ybc_block_slider<?php }
}?>">
                <h4 class="title_blog title_block"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value['title'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</h4>
                ...
                <div class="ybc_blog_content_block <?php if ((isset($_smarty_tpl->tpl_vars['blog_page']->value)) && $_smarty_tpl->tpl_vars['blog_page']->value == 'home') {?>
    <?php if ((isset($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_HOME_POST_TYPE'])) && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_HOME_POST_TYPE'] == 'default' || count($_smarty_tpl->tpl_vars['category']->value['posts']) <= 1) {?>ybc_block_default<?php } else { ?>blog_type_slider<?php }
} else { ?>
    <?php if ((isset($_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_SIDEBAR_POST_TYPE'])) && $_smarty_tpl->tpl_vars['blog_config']->value['YBC_BLOG_SIDEBAR_POST_TYPE'] == 'default' || count($_smarty_tpl->tpl_vars['category']->value['posts']) <= 1) {?>ybc_block_default<?php } else { ?>blog_type_slider<?php }
}?>"><?php
...
">
                                <img width="<?php echo htmlspecialchars((string) Configuration::get(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( 'YBC_BLOG_IMAGE_BLOG_THUMB_WIDTH','html','UTF-8' ))), ENT_QUOTES, 'UTF-8');?>
...
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Liked','mod'=>'ybc_blog'),$_smarty_tpl ) );?>
                                ...
                                <?php }?>
                                <?php if ((isset($_smarty_tpl->tpl_vars['display_desc']->value)) && $_smarty_tpl->tpl_vars['display_desc']->value) {?>
                                    <?php if ($_smarty_tpl->tpl_vars['post']->value['short_description']) {?>
                                        <div class="blog_description">
                                            <p>
                                                <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( strip_tags($_smarty_tpl->tpl_vars['post']->value['short_description']),120,'...' )),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>

                                            </p>
                                        </div>
                                    <?php } elseif ($_smarty_tpl->tpl_vars['post']->value['description']) {?>
                                        <div class="blog_description">
                                            <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( strip_tags($_smarty_tpl->tpl_vars['post']->value['description']),120,'...' )),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['blog_page']->value != 'home') {?>
                    <div class="blog_view_all_button">
                        <a href="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['category']->value['link_all'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
" class="view_all_link" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View all posts','mod'=>'ybc_blog'),$_smarty_tpl ) );?>
"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View all posts','mod'=>'ybc_blog'),$_smarty_tpl ) );?>
</a>
                    </div>
                <?php }?>
                </div>
