<?php
  ...
  $req_dup='SELECT DISTINCT od.id_order FROM `ps_order_detail` od JOIN ps_orders o on (od.id_order=o.id_order) WHERE od.product_id IN (1575,1576,2541,1940,3939,2542,2335,3860,2334) AND o.current_state IN (40) AND o.date_add >= "2024-05-13 00:00:00";';
