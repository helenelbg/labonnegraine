...
die;
  ...
  function dupliquer_commande($id_commande)
  {
    ...
    if ( !in_array($id_commande, $histo) )
    {
      ...
      $req_dup_reg='SELECT DISTINCT od.id_order FROM `ps_order_detail` od JOIN ps_orders o on (od.id_order=o.id_order) WHERE o.id_customer = "'.$old_order->id_customer.'" AND o.id_order <> "'.$id_commande.'" AND od.product_id IN (3857,3858) AND o.current_state NOT IN (1,6,7,8,10) AND o.date_add >="2024-01-01 00:00:00";';
	...
	$history->changeIdOrderState($etat_commande, $new_order->id);
      ...
      $req_dup_reg='SELECT DISTINCT od.id_order FROM `'.
              ...
              . ' WHERE o.id_customer = "'.$old_order->id_customer.'" AND o.id_order <> "'.$id_commande.'" AND o.id_order <> "'.$new_order->id.'" AND od.product_id IN (3857,3858) AND o.current_state NOT IN (1,6,7,8,10) AND o.date_add >="2024-01-01 00:00:00";';
      $T_lignes_dup_reg = Db::getInstance()->executeS($req_dup_reg);
  ...
  $req_dup='SELECT DISTINCT od.id_order, o.id_customer FROM `ps_order_detail` od JOIN ps_orders o on (od.id_order=o.id_order) WHERE od.product_id IN (3857,3858) AND o.current_state NOT IN (1,6,7,8,10) AND o.date_add >= "2024-01-01 00:00:00";';
  echo $req_dup.'<br />';
